    ...
    <div className="text-white">
      <div className='w-full text-white'>
        <div className='w-full h-full'>
          <div className='absolute w-full  h-[1100px]  md:h-[780px]  bg-gradient-to-r from-zinc-900'></div>
          <img className='object-cover h-[1100px] md:w-full md:h-[780px]' src={`https://image.tmdb.org/t/p/original/${movie?.backdrop_path}`} alt={movie.title} />
        </div>
